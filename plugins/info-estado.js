...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[1]} 𝐅𝐞𝐫𝐱𝐚 𝐁𝐨𝐭
  ${tradutor.texto1[2]} +56971531036
  ${tradutor.texto1[3]} https://www.instagram.com/ff_ferxa.rb
  ...
  const Message = {
    document: { url: `https://www.instagram.com/ff_ferxa.rb` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://www.instagram.com/ff_ferxa.rb",
        mediaType: 2,
        previewType: "pdf",
        title: "𝐅𝐞𝐫𝐱𝐚 𝐁𝐨𝐭",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://www.instagram.com/ff_ferxa.rb",
      },
    },
    caption: info,
    footer: wm,
