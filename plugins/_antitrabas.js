...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  const fakemek = { 'key': { 'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net' }, 'message': { 'groupInviteMessage': { 'groupJid': '56971531036-1616969743@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': '𝐅𝐞𝐫𝐱𝐚 𝐁𝐨𝐭', 'jpegThumbnail': null } } };
